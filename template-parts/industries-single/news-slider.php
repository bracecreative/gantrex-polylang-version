<section class="post-slider-section bg-white py-40">

    <div class="max-w-full lg:max-w-[50%] mb-10 mx-auto">
        <h2 class="sen-bold uppercase text-primary tracking-tighter text-[35px] text-center">Related <mark class="bg-accent px-2 text-white">news<mark></h2>
    </div>
...
<div class="mx-auto max-w-[1364px] flex justify-center pt-20">
    <a href="">
        <div class="gtx-btn border-2 border-accent px-6 py-2 flex items-center justify-center hover:bg-accent">
            <span class="sen uppercase font-bold tracking-widest text-base text-primary flex items-center">read all news</span>
        </div>
    </a>
</div>
