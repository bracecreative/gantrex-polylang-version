...
<section class="post-slider-section bg-primary py-40" style="background-image: url(<?php echo get_stylesheet_directory_uri();?>/images/component_bg/background-2.png); background-position: center center; background-fit:cover;">
