...
?>
    <div class="archive-card-hover max-w-[1360px] gap-4 w-[80%] flex-wrap explore-cards py-[100px] pt-[0px] flex m-auto justify-center">
        <?php
        $args = array(
            'post_type'         => 'products',
            'post_status'       => 'publish',
        ...
        <a class="relative flex flex-col items-center justify-center w-[438px] h-[300px] overflow-hidden group"
            ...
            <h3 class="max-w-[90%] text-center text-[35px] text-white sen-bold uppercase  z-10">
                <?php the_title(); ?></h3>
