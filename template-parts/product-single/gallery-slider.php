<section class="bg-secondary pt-28 pb-28">
  ...
  <div class="swiper-container" x-ref="container">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <div>
                <img class="min-h-[200px] w-auto object-cover object-center" src="https://via.placeholder.com/728x90.png?text=Placeholder+Image" alt="">
            </div> 
        </div>
