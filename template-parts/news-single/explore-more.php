...
<section class="post-slider-section bg-primary py-40" style="background-image: url(<?php echo get_stylesheet_directory_uri();?>/images/component_bg/background-3.png); background-position: center center; background-fit:cover;">
...
<div class="flex justify-center">
    ...
    <div class="flex max-w-[1360px] flex-col lg:flex-row gap-4 justify-center w-[80%]">
        ...
        <div class="flex flex-col w-full max-h-[412px] group overflow-hidden transition-all duration-500 cursor-pointer">
            ...
            <div class="h-full group-hover:min-h-[100%] transition duration-500 ease-in-out bg-clip-content bg-cover bg-center bg-no-repeat" style="background-image: url(<?php echo get_template_directory_uri() . '/images/crane-placeholder.jpg' ?>);">
        ...
        <div class="flex flex-col w-full max-h-[412px] group overflow-hidden transition-all duration-500 cursor-pointer">
            <img class="hidden lg:block transition-height h-1/2 group-hover:h-0 duration-500 ease object-cover" src="<?php echo get_template_directory_uri() . '/images/products.jpg' ?>" alt="">
            
            <div class="relative h-full group-hover:min-h-[100%] transition duration-500 ease-in-out bg-clip-content bg-cover bg-center bg-no-repeat" style="background-image: url(<?php echo get_template_directory_uri() . '/images/products.jpg' ?>);">

                <div class="flex flex-col justify-between items-center h-full w-full bg-light transition-height duration-500 ease-in-out group-hover:bg-opacity-90 group-hover:h-[100%] p-10">
                    <h4 class="heading--xs font-medium text-primary leading-7 mb-2 text-center"><?php echo __('Our Products', 'brace-starter-theme') ?></h4>
